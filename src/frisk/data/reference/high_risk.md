# Higher-risk reference lists (context — not scoring rules)

These are *prior context* for judgement, not automatic escalations. Being on a list raises attention;
...
ownership, or easily used to move value.

**Other prior-risk signals:** Politically Exposed Person (PEP — official or their family; corruption
exposure), very new account with high-value activity, incomplete/expired KYC, complex cross-border flows.
